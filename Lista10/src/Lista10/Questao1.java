...
public class Questao1 {
	...
	public static void divisivel(int numero, int divisor) {
		if(numero%divisor == 0) {
	...
	public static void arredondar(double numero) {
		System.out.println("Número " + numero + " arredondado: " + Math.round(numero));
	}
